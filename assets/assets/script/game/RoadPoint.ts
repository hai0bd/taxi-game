...
export class RoadPoint extends Component {
    ...
    @property({
        displayOrder: 4, visible: function (this: RoadPoint) {
    ...
    @property({
        displayOrder: 5, visible: function (this: RoadPoint) {
    ...
    @property({
        displayOrder: 6, visible: function (this: RoadPoint) {
            return this.type === ROAD_POINT_TYPE.AI_START;
        }
    })
    interval = 3;
    ...
    @property({
        displayOrder: 7, visible: function (this: RoadPoint) {
            return this.type === ROAD_POINT_TYPE.AI_START;
        }
    })
    speed = 0.05;
    ...
    @property({
        displayOrder: 8, visible: function (this: RoadPoint) {
            return this.type === ROAD_POINT_TYPE.AI_START;
        }
    })
    cars = '201';
